node {
    ...
    try {
        ...
        stage('Apply Ingress') {
           ...
           bat "kubectl apply -f \"${WORKSPACE}\\food-drug-service-chat\\templates\\ingress.yaml\" --namespace default"

          //  bat 'kubectl apply -f config/ingress.yaml --namespace default || exit 255' // Adjust the path as necessary
